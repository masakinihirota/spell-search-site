...
import type { SpellCast } from "@/types";
				...
				<div>
					<div className="p-4 bg-gray-50 border-b border-gray-200">
						<h2 className="text-lg font-semibold">
							呪文をクリックで購入:{" "}
							<span className="text-blue-600">{results.length}</span> 件
						</h2>
					</div>
							...
							>
								<div className="p-4">
									...
									<div className="mt-2 flex items-center text-sm text-gray-500">
										<span className="mr-4">
											<span className="font-medium">必要な歌の段:</span>{" "}
											{spell.requiredSong}
										</span>
										<span>
											<span className="font-medium">唱える段の順番:</span>{" "}
											{spell.castOrder}
										</span>
									</div>
