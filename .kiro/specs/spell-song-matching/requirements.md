...
1. WHEN マッチング情報を表示する THEN システムは所持歌数字、不足数字、マッチング率を呪文の右上に横並びで表示する SHALL
2. WHEN マッチング情報を表示する THEN システムは各情報を異なる色で区別して表示する SHALL
3. WHEN マッチング率が100%の場合 THEN システムは完全マッチを示す特別な表示を行う SHALL
4. WHEN マッチング率が0%の場合 THEN システムは通常の表示のまま維持する SHALL
5. WHEN マッチング率が1%以上の場合 THEN システムは背景色を少し見やすく変更する SHALL
6. WHEN マッチング率が高くなる THEN システムは段階的により目立つ背景色で表示する SHALL
7. WHEN マッチング率が100%の場合 THEN システムは最も目立つ背景色と太い枠線で表示する SHALL
